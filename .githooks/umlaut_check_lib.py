...
UMLAUT_WHITELIST = [
    ...
    'Pipeline', 'Plugin', 'Process', 'pruef', 'Queue', 'rescue',
    'Sandbox', 'schaetzle', 'Schedule', 'schmeissner', 'Session', 'Source',
    'Stage', 'Status', 'Trace', 'User', 'Value', 'vorausschauend',
]
